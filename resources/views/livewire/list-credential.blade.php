...
>
    <main class="wrapper w-full md:max-w-6xl mx-auto pt-20 px-4">
        <header class="flex justify-between">
            <div>
                <h1 class="text-xl font-medium text-gray-950 dark:text-white">Default Credentials Cheat Sheet</h1>
            ...
            <div class="flex gap-1">
                <a
                    class="block content-center w-full rounded-md whitespace-nowrap px-3 py-2 text-sm font-normal text-gray-700 hover:bg-gray-100 focus:bg-gray-200 focus:outline-none active:text-zinc-800 active:no-underline disabled:pointer-events-none disabled:bg-transparent disabled:text-gray-400 dark:text-gray-100 dark:hover:bg-gray-600 focus:dark:bg-gray-600"
        ...
        <footer class="pt-4 pb-8 text-sm text-gray-500 dark:text-gray-300">
            <p>
                Just for fun!
            </p>
        </footer>
